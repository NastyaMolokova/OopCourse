...
public class Triangle implements Shape {
    ...
    public double getPerimeter() {
        double triangleSide1Length = getSideLength(x1, y1, x2, y2);
        double triangleSide2Length = getSideLength(x1, y1, x3, y3);
        double triangleSide3Length = getSideLength(x2, y2, x3, y3);
